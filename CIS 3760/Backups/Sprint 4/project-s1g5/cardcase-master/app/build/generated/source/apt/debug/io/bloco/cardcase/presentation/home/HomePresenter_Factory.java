...
public final class HomePresenter_Factory implements Factory<HomePresenter> {
  ...
  public HomePresenter_Factory(Provider<GetUserCard> getUserCardProvider, Provider<GetReceivedCards> getReceivedCardsProvider, Provider<DeleteCard> deleteCardProvider, Provider<SaveReceivedCards> saveReceivedCardsProvider, Provider<AnalyticsService> analyticsServiceProvider) {  
  ...
  public HomePresenter get() {  
    return new HomePresenter(getUserCardProvider.get(), getReceivedCardsProvider.get(), deleteCardProvider.get(), saveReceivedCardsProvider.get(), analyticsServiceProvider.get());
  }

  public static Factory<HomePresenter> create(Provider<GetUserCard> getUserCardProvider, Provider<GetReceivedCards> getReceivedCardsProvider, Provider<DeleteCard> deleteCardProvider, Provider<SaveReceivedCards> saveReceivedCardsProvider, Provider<AnalyticsService> analyticsServiceProvider) {  
    return new HomePresenter_Factory(getUserCardProvider, getReceivedCardsProvider, deleteCardProvider, saveReceivedCardsProvider, analyticsServiceProvider);
  }
}
