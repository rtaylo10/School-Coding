...
public final class DaggerActivityComponent implements ActivityComponent {
  ...
  private void initialize(final Builder builder) {  
    ...
    this.homePresenterProvider = ScopedProvider.create(HomePresenter_Factory.create(getUserCardProvider, getReceivedCardsProvider, deleteCardProvider, analyticsServiceProvider));
