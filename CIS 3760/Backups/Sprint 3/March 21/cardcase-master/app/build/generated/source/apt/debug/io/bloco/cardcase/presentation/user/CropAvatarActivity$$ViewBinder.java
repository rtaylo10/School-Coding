...
public class CropAvatarActivity$$ViewBinder<T extends io.bloco.cardcase.presentation.user.CropAvatarActivity> implements ViewBinder<T> {
  @Override public void bind(final Finder finder, final T target, Object source) {
    View view;
    view = finder.findRequiredView(source, 2131689586, "field 'cropView'");
    target.cropView = finder.castView(view, 2131689586, "field 'cropView'");
    view = finder.findRequiredView(source, 2131689587, "method 'crop'");
